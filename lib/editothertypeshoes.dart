...
class Editothertypeshoes extends StatefulWidget {
  final Addshoesclass sindex;
  Editothertypeshoes({super.key, required this.sindex});

  @override
  State<Editothertypeshoes> createState() => _EditshoesState();
}

class _EditshoesState extends State<Editothertypeshoes> {
