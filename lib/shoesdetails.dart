...
class ShoesDetails extends StatefulWidget {
  final int sindex;
  const ShoesDetails({super.key, required this.sindex});
...
class _ShoesDetailsState extends State<ShoesDetails> {
  ...
  Widget build(BuildContext context) {
    final shoe = allshoes[widget.sindex];
    return Scaffold(
            ...
            Row(
              ...
              children: [
                IconButton(
                  ...
                  onPressed: () {
                    setState(() {
                      if (allshoes[widget.sindex].category == 'men') {
                        menshoes.removeWhere(
                          (element) =>
                              element.image == allshoes[widget.sindex].image,
                        );
                      }
                      if (allshoes[widget.sindex].category == 'women') {
                        womenshoes.removeWhere(
                          (element) =>
                              element.image == allshoes[widget.sindex].image,
                        );
                      }
                      if (allshoes[widget.sindex].category == 'kids') {
                      ...
                      allshoes.remove(allshoes[widget.sindex]);
                    });
